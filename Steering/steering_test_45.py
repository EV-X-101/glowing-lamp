...
target_degree = 0
print("Calibrate the center by manually adjusting the steering wheel, then press enter...")
input()
encoder_center = read_adc(0)
print(f"Center calibration done. ADC reading: {encoder_center}")
...
def run_motor():
    ...
    while True:
        ...
        output = pid(position)
        # print(f"Position: {position}, Target ADC: {pid.setpoint}, PID output: {output}")  # Debugging line
